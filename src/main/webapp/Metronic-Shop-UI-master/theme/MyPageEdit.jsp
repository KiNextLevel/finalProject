...
<form action="/updateProfile.do" method="POST" role="form" class="form-horizontal form-without-legend">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea class="form-control" id="userDescription" name="userDescription" rows="6"
                          maxlength="200">${userDTO.userDescription}</textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" id="region" name="userRegion" value="${userDTO.userRegion}"
                       readonly>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <select class="form-control" name="userSmoke">
                    <option value="">선택하세요</option>
                    <option value="0" ${userDTO.userSmoke == 0 ? 'selected' : ''}>비흡연</option>
                    <option value="1" ${userDTO.userSmoke == 1 ? 'selected' : ''}>흡연</option>
                </select>
